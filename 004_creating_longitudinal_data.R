...
# producing dataset
immig_df <- df %>% 
  select(immigSelf, contains("affordability"), contains("pop_density"), 
         contains("foreign_per_1000"), contains("over_65_pct"), 
         contains("under_15_pct"), contains("gdp_capita"), 
         contains("manuf_pct"), contains("price"),
         degree_pct, degree_pct_change, uni, white, no_religion, 
